...
export const DetailRapot = () => {
  ...
  const fetchKepsek = async () => {
    axios.get("http://127.0.0.1:8000/api/show-kepsek").then((res) => {
      setKepsek(res.data.data);
    });
  };
          ...
          <article className="mt-3">
            ...
            <table className="border-2 w-full border-black space-x-4 border-collapse text-center text-xs mt-10">
              <thead className="">
                ...
                <tr>
                  ...
                  <th className="w-80 border border-black font-normal">
                    Huruf
                  </th>
            ...
            <div className="p-1 border-2 border-black mt-5">
              ...
              <p>
                ...
                dolor sint iste veniam quam alias quo, blanditiis aliquam, sit
                mollitia totam magnam adipisci aliquid id. Aliquid, ipsa enim.
                Numquam alias libero laboriosam iure maxime laborum molestiae
                provident blanditiis quam aliquid.
              </p>
            </div>
            <div className="mt-5">
              ...
              <tr>
                ...
                <td>
                  <div>
                    ...
                    <img
                      src={`http://127.0.0.1:8000/storage/tanda-tangan/${kepsek.tanda_tangan}`}
                      alt="tanda tangan"
                      width={200}
                      height={200}
                      className="self-center"
