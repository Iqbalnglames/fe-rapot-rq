...
export const AddNilaiSantri = () => {
  ...
  const handleDetailSantri = async () => {
    await axios.get(`https://rapot.api.techbatchtech.my.id/api/rapot/${slug}`).then((res) => {
  ...
  const fetchTahunAjaran = async () => {
    try {
      const res = await axios.get("https://rapot.api.techbatchtech.my.id/api/tahun-ajaran");
  ...
  const fetchDetailMapel = async () => {
    try {
      const url = slugMapel
        ? `https://rapot.api.techbatchtech.my.id/api/mapel/${slugMapel}`
        : "https://rapot.api.techbatchtech.my.id/api/kategori-mapel";
